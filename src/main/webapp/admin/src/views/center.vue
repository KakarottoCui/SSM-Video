<template>
  <div>
    ...
    >  
     <el-row>
                              <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="用户ID" prop="xuehao">
          <el-input v-model="ruleForm.xuehao" readonly              placeholder="用户ID" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="观众用户姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming"               placeholder="观众用户姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="媒体用户工号" prop="jiaoshigonghao">
          <el-input v-model="ruleForm.jiaoshigonghao" readonly              placeholder="媒体用户工号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="媒体用户姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"               placeholder="媒体用户姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item v-if="flag=='jiaoshi'" label="照片" prop="zhaopian">
          ...
          ></file-upload>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="级别" prop="zhicheng">
          <el-input v-model="ruleForm.zhicheng"               placeholder="级别" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
