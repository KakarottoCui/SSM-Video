  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">波波视频管理平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
															<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">用户ID</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xuehao" class="input" type="text" placeholder="用户ID">
			   </div>
			 </div> -->
			<el-form-item label="用户ID" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuehao" autocomplete="off" placeholder="用户ID" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
												...
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">观众用户姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueshengxingming" class="input" type="text" placeholder="观众用户姓名">
			   </div>
			 </div> -->
			<el-form-item label="观众用户姓名" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xueshengxingming" autocomplete="off" placeholder="观众用户姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			   ...
			   <div class="label">媒体用户工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshigonghao" class="input" type="text" placeholder="媒体用户工号">
			   </div>
			 </div> -->
			<el-form-item label="媒体用户工号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshigonghao" autocomplete="off" placeholder="媒体用户工号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
												...
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">媒体用户姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshixingming" class="input" type="text" placeholder="媒体用户姓名">
			   </div>
			 </div> -->
			<el-form-item label="媒体用户姓名" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshixingming" autocomplete="off" placeholder="媒体用户姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">级别</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhicheng" class="input" type="text" placeholder="级别">
			   </div>
			 </div> -->
			<el-form-item label="级别" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.zhicheng" autocomplete="off" placeholder="级别" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://img-baofun.zhhainiao.com/fs/e0fbbe8b65f702e8b94276751c1f3785.jpg");
		height: 100vh;
